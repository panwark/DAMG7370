...
-- 🔑 Step 2: Create Scoped Credential for Managed Identity

CREATE DATABASE SCOPED CREDENTIAL cred_project

WITH IDENTITY = 'Managed Identity';
 
-- 📁 Step 3: Create External Data Sources for Silver and Gold
...
WITH (
    ...
    LOCATION = 'https://teensafety.dfs.core.windows.net/gold',

    CREDENTIAL = cred_project

);
 
-- 📦 Step 4: Define File Format (Parquet)
...
-- 🪄 Step 5: Create External Tables from Gold Views
